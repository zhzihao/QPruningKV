...
class LLMNeedleHaystackTester:
    ...
    def __init__(self,
        ...
        if(self.model_provider in ["LLaMA3", "Mistral"]):
            ...
            if self.method in ["pyramidkv", "snapkv","streamingllm","layerquant","h2o"]:
                ...
                self.model_to_test._supports_quantized_cache=True
        ...
        if(self.model_provider in ["LLaMA3", "Mistral"]):
            ...
            if args.quant_method == None:        
                ...
                output_ids = self.model_to_test.generate(
                    ...
                    cache_config={"nbits": args.nbits, "backend": "HQQ","device":"cuda","residual_length":30,"axis_key":args.key_axis,"q_group_size":args.group_size},
                )
                print("quant generate")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--method', type=str, default="full", choices=['full', 'pyramidkv', 'snapkv', 'streamingllm', 'h2o', "layerquant"])
